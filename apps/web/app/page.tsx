...
type ScriptDetail = ScriptSummary & { verification_report: { valid?: boolean; deterministic_valid?: boolean; requires_independent_verification?: boolean; issues?: Array<{ code: string; message: string; segment_key: string | null; statement: string | null }> }; segments: ScriptSegment[]; automatic_continuation?: AutomaticContinuation | null };
